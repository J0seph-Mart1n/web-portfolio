      ...
      <div className="w-full flex justify-center mb-20 relative z-10">
        <div className="relative w-full max-w-sm mx-auto">
          ...
          <div className="min-h-[64px] flex items-center justify-center mt-8">
            <h3 className="text-[25px] font-bold text-zinc-400 tracking-wide text-center animate-in fade-in slide-in-from-top-2 duration-500">
              {currentCaption}
            </h3>
          </div>
        </div>
      ...
      <section className="mb-24">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-2">
                  The dashboard uses an intuitive Bento grid layout. For key metrics like the Health Score, the app utilizes <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">react-native-svg</code> to dynamically calculate radial progress rings (e.g., dynamically mapping the LLM's integer score to an exact <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">strokeDashoffset</code> coordinate) for a polished, native feel.
                </p>
              </div>
              <div>
                <h4 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
                ...
                <p className="text-gray-400 leading-relaxed mb-2">
                  To provide a seamless UX during API calls, the app integrates <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">react-native-reanimated-skeleton</code> for rich "shimmer" skeleton loading states across its swipeable timelines.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-2">Built on the <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">gin-gonic/gin</code> framework for high-concurrency routing. Custom middleware intercepts requests to decode Firebase JWT tokens, passing the verified <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">UID</code> into the request context to ensure secure, per-user MongoDB isolation via the official <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">mongo-driver</code>.</p>
              </div>
              <div>
                <h4 className="text-lg font-semibold text-white mb-2 flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: project.color }} />
        ...
        <div className="space-y-6 mb-16">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 relative overflow-hidden">
            ...
            <p className="text-zinc-400 leading-relaxed">
              To keep track of progress, the <strong>History Page</strong> features two specialized swipeable tabs for <em>Scan History</em> and <em>Daily Logs</em>. It relies on a robust MongoDB fetching architecture, with the frontend utilizing <code className="text-zinc-400 bg-white/10 px-2 py-0.5 rounded">react-native-reanimated-skeleton</code> to render beautiful, frictionless shimmer loading states while synchronizing historical user data in real-time.
            </p>
          </div>
        </div>
